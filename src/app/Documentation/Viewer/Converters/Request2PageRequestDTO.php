...
final readonly class Request2PageRequestDTO implements ConverterContract
{
    /**
     * @param Request $request
     * @return PageRequestDTO
     */
    public function convert(#[ExpectedType(Request::class)] object $request): PageRequestDTO
    {
        $lang = $request->lang;
        if ($lang === null) {
            $lang = 'rus';
